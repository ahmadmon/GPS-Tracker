...
@section('content')
            ...
            <div class="row">
                <div class="col-sm-12 d-flex">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item dana">ایجاد سازمان جدید</li>
                    </ol>
                </div>
            </div>
        </div>
    ...
    <form action="{{ route('company.store') }}" method="POST" class="row" autocomplete="off" enctype="multipart/form-data">
        @csrf
        <div class="row">
            <div class="col-xl-4">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input class="form-control" id="contact_number" dir="ltr" name="contact_number" value="{{ old('contact_number') }}"
                                   type="text">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <x-partials.alpine.select2.select-option name="user_id" :options="$managers->pluck('name' , 'id')->toArray()" />
    ...
    <script>
        document.addEventListener('alpine:init', () => {
            Alpine.data('previewImage', (input) => ({
                ...
                defalutImage: '{{ asset('assets/images/custom/workplace-512px.png') }}',
                imageSrc: '',
