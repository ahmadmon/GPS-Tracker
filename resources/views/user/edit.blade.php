            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="col-12 mb-3">
                        ...
                        <input class="form-control" id="phone" dir="ltr" name="phone" value="{{ old('phone', $user->phone) }}"
                               type="text">
                    ...
                    <div class="col-12 mb-3">
                        ...
                        <select class="form-select" name="status" id="status">
                            ...
                            <option value="1" selected @selected(old('status', $user->status) == 1)>فعال</option>
                        </select>
                ...
                <div class="card-body">
                        ...
                        <div class="d-flex align-items-center justify-content-between flex-wrap"
                            ...
                            @foreach($roles as $role)
                                <div class="form-check">
                                    <input class="form-check-input" id="role-{{ $role->id }}" value="{{ $role->id }}"
                    ...
                    <div class="card-wrapper border rounded-3 h-100 checkbox-checked">
                        ...
                        <div x-data="permissionsList" class="row">
                            <div class="col-12" @updated-role.window="['super-admin', 'developer'].includes($event.detail.roleName) ? selectAll() : deselectAll()">
                                ...
                                <button type="button"
                                    ...
                                    <svg class="me-1" xmlns="http://www.w3.org/2000/svg" width="15" height="15"
                                        ...
                                        <mask id="lineMdCheckAll0">
                                            <g fill="none" stroke="#fff" stroke-dasharray="24" stroke-dashoffset="24"
