                        ...
                        <div class="default-according style-1 faq-accordion">
                            ...
                            <div class="card">
                                ...
                                <div class="collapse" id="ques-4" aria-labelledby="ques-4"
                                     data-bs-parent="#accordionoc">
                                    <div class="card-body">
                                        بله! اگر تا 24 ساعت از استفاده از سامانه و اشتراک خود راضی نباشید، می‌توانید با
                                        تیم پشتیبانی تماس بگیرید و درخواست عودت وجه کنید.
                                        <br>
                                        اگر لغو اشتراک شما قبل از شش ماه باشد، ۳۰ درصد وجه شما عودت داده می‌شود. اما اگر پس از شش ماه تصمیم به لغو اشتراک بگیرید، متاسفانه وجهی عودت داده نمی‌شود.

                                        ما همیشه آماده کمک به شما
                                        هستیم!
                                    </div>
                                </div>
                            </div>
