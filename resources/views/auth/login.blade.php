...
@section('content')
    <div class="row m-0">
        <div class="col-xl-7 p-0">
            <img class="bg-img-cover bg-center" src="{{ asset('assets/images/login/gps-vector.svg') }}" alt="صفحه ورود">
        </div>
                    ...
                    <div class="d-flex justify-content-start align-items-center">
                        <a class="logo text-start me-2" href="javascript:void(0)">
                            <img class="img-fluid for-light" width="50"
                                src="{{ asset('assets/images/logo/samfa-logo.png') }}" alt="صفحه ورود">
                            <img class="img-fluid for-dark" width="50"
                                src="{{ asset('assets/images/logo/samfa-logo.png') }}" alt="صفحه ورود">
                        </a>
                        <h3 class="fw-bold pb-4 auth-title">سَمـفـا - سامانه هوشمند ردیابی GPS</h3>
                    </div>
                    <div class="login-main">
                        <form action="{{ route('login') }}" class="theme-form" method="POST" autocomplete="off" autofocus
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control txt-dark fw-bold" id="phone" dir="ltr" type="text"
                                    name="phone" value="{{ old('phone', request()?->phone) }}" autofocus
                                    autocomplete="phone" x-model="phone" placeholder="09123456789">
                                <x-input-error :messages="$errors->get('phone')" class="mt-2" />
                                <div x-show="error" x-cloak>
                                    <span class="text-danger mt-1 fw-bold" x-text="'لطفا شماره موبایل, وارد کنید.'"></span>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="password" class="col-form-label">گذرواژه</label>
                                <div class="form-input position-relative">
                                    <input class="form-control txt-dark fw-bold" type="password" dir="ltr"
                            ...
                            <div class="form-group mb-0">
                                ...
                                <a :href="phone.length === 11 ? `/otp/verification/${phone}` : 'javascript:void(0)'"
