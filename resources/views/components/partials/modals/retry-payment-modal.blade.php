            ...
            <div class="modal-body">
                <div class="modal-toggle-wrapper">
                    <h6>آیا مایل هستید این تراکنش را از طریق درگاه پرداخت تکمیل کنید یا دستی وضعیت آن را مشخص
                        نمایید؟</h6>
                    <a role="button" href="#" class="btn btn-primary w-100 mt-4 mb-1">انتقال به درگاه پرداخت</a>
                    <button class="btn w-100 pb-0 dark-toggle-btn" type="button" data-bs-target="#exampleModalToggle2"
...
<div class="modal fade" id="exampleModalToggle2" aria-hidden="true" aria-labelledby="exampleModalToggle2" tabindex="-1" x-data="retryPaymentModal">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h4>تغییر وضعیت تراکنش <small class="text-muted" x-text="transaction?.transaction_number"></small></h4>
