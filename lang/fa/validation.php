...
return [
    ...
    'attributes' => [
        ...
        'type' => 'نوع کوپن',
        'otp' => 'رمز یکبار مصرف',
        'profile_photo_path' => 'تصویر کاربر',
        'browser_title' => 'عنوان صفحه در مرورگر',
        'current_password' => 'گذرواژه فعلی',
        'subject' => 'موضوع',
        'under_title' => 'زیر عنوان',
        'webSite' => 'وبسایت',
        ...
        'section_id' => 'بخش',
        'report_id' => 'گزارش',
        'credit_card_image' => 'عکس کارت ملی',
        'bank_account_name' => 'نام صاحب حساب',
        'bank_name' => 'نام بانک',
        'bank_account_number' => 'شماره حساب',
        'bank_card_number' => 'شماره کارت',
        'bank_shaba_number' => 'شماره شبا',
        'bank_card_image' => 'عکس کارت بانکی',
        'fixedPhone' => 'تلفن ثابت',
        'postalCode' => 'کد پستی',
        'websiteIcon' => 'آیکون سایت',
        'websiteLogo' => 'لوگو سایت',
        'seo_keywords' => 'کلمات کلیدی سئو',
        'seo_description' => 'توضیحات سئو',
        'allow_comment' => 'امکان ثبت‌نظر',
        'show_header' => 'نمایش هدر',
        'show_footer' => 'نمایش فوتر',
        'style_code' => 'استایل شخصی',
        'script_code' => 'اسکریپت شخصی',
        'all_admin' => 'همه عوامل',
        'national_card' => 'کارت ملی',
        'shop_name' => 'نام فروشگاه',
        'shop_logo' => 'لوگو فروشگاه',
        'shop_address' => 'آدرس فروشگاه',
        'shop_postal_code' => 'کدپستی فروشگاه',
        'shop_tel' => 'تلفن فروشگاه',
